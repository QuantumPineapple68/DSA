...
//    }
    ...
    static void skipIfA (String result, String given){
        if (given.isEmpty()){
        ...
        if (ch == 'a' || ch == 'A'){
            skipIfA(result,given.substring(1));
        }
        else{
            skipIfA(result+ch, given.substring(1));
        }
    }


    static String skipIfA (String given){
        if (given.isEmpty()){
            return "";
        }
        ...
        char ch = given.charAt(0);
        if (ch == 'a' || ch == 'A'){
            return skipIfA(given.substring(1));
        }
        else{
            return ch + skipIfA(given.substring(1));
        }
    }

    static String skipAppIfNotApple (String given){
        if (given.isEmpty()){
            return "";
        }
        ...
        if (given.startsWith("app") && !given.startsWith("apple")){
            ...
            return given.charAt(0) + skipAppIfNotApple(given.substring(1));
        }
    }
}